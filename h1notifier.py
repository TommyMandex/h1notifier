...
def getreports():
    ...
    sort_report_filter = {
        'Popular': None  ,
        'New': {"latest_disclosable_activity_at":{"_direction":"DESC"}}
    }
    h1_json = {"operationName": "HacktivityPageQuery","variables":{"querystring":"","where":type_report_filters['Bug Bounty'],
               "orderBy":{"field":"popular","direction":"DESC"},
               "secureOrderBy":sort_report_filter['New'],"count":50,"maxShownVoters":10},
